...
opts.Add(PathVariable('target_path', 'The path where the lib is installed.', 'dist/bin/imgui/'))
opts.Add(PathVariable('target_name', 'The library name.', 'libgdimgui', PathVariable.PathAccept))
